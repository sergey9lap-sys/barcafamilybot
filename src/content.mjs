...
export const contentDefaults={
 ...
 season_hint:{label:'Под рейтингом сезона',text:'📅 В сезонном рейтинге учитываются только завершённые голосования. Складываем средние оценки за матчи — это сумма баллов за сезон.',entities:[]},
